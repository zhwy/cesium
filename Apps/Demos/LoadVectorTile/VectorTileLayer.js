...
import createProvider from "./VectorTile/createProvider.js";
...
export default class VectorTileLayer {
  ...
  constructor(options, quadtreePrimitive) {
    this._option = { ...defaultOptions, ...options };
    this._layer = { quadtreePrimitive };
  ...
  init() {
    let quadtreePrimitive = this.quadtreePrimitive;
    if (!quadtreePrimitive) {
      quadtreePrimitive = new VectorTileQuadtreePrimitive({
        tileProvider: createProvider(this._option),
        ...this._option.quadtreePrimitive,
      });
      this._layer.quadtreePrimitive = quadtreePrimitive;
    }

    quadtreePrimitive.addVisualizer(this);
    quadtreePrimitive.tileProvider.freeTile.addEventListener(
      this.destroyTile,
      this,
    );
