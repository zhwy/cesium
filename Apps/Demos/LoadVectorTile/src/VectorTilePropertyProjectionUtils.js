 ...
 * @returns {object}
 */
export function createVectorTilePropertyProjections(
  styleDocument,
  options = {},
) {
  ...
  for (const [sourceLayer, layers] of layersBySourceLayer) {
    const style = collectVectorStylePropertyDependencies(
...
export function projectVectorTileProperties(properties, projection) {
...
export function getPublicPickProperties(properties, pickProperties) {
